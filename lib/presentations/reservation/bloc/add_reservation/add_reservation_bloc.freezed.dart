...
class _$AddReservationImpl implements _AddReservation {
  ...
  @override
  String toString() {
    return 'AddReservationEvent.addReservation(customerName: $customerName, customerPhone: $customerPhone, notes: $notes, status: $status, reservationDate: $reservationDate, reservationTime: $reservationTime, tableNumber: $tableNumber)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, customerName, customerPhone,
      notes, status, reservationDate, reservationTime, tableNumber);
  ...
  TResult when<TResult extends Object?>({
    ...
    return addReservation(customerName, customerPhone, notes, status,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return addReservation?.call(customerName, customerPhone, notes, status,
        reservationDate, reservationTime, tableNumber);
  }
