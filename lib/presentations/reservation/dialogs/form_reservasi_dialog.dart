...
class _FormDiscountDialogState extends State<FormReservasiDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final resTimeController =
      ...
      final notesController = TextEditingController(text: widget.data?.notes?? '');
      final tableController = TextEditingController(text: widget.data?.tableNumber?? '');
      final nameController = TextEditingController(text: widget.data?.customerName?? '');
      final phoneController = TextEditingController(text: widget.data?.customerPhone?? '');
    ...
    return AlertDialog(
      title: Row(
        ...
        children: [
          ...
          Text(widget.data == null ? 'Tambah Reservasi' : 'Edit Diskon'),
          const Spacer(),
        ],
      ),
            ...
            children: [
              ...
              Button.filled(
                onPressed: () {
                  ...
                  String message = 'Reservasi: ${widget.data!.customerName}\n'
